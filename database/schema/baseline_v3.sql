...
CREATE TABLE `data_modules` (
  ...
  `domain_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属领域标识',
  `domain_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '领域显示名',
  `resource_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '对应 access_relations.resource_type',
  `org_unit_field` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'org_unit_id' COMMENT '表中的组织字段名',
  `creator_field` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'created_by',
  `sort_order` int DEFAULT '0',
  `enabled` tinyint(1) DEFAULT '1',
  `industry` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属行业插件(NULL=通用核心)',
  `plugin_enabled` tinyint(1) DEFAULT '1' COMMENT '插件是否启用',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_code` (`tenant_id`,`module_code`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='动态数据模块配置';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `data_modules`
--

LOCK TABLES `data_modules` WRITE;
/*!40000 ALTER TABLE `data_modules` DISABLE KEYS */;
INSERT INTO `data_modules` VALUES (1,1,'org_unit','组织单元','organization','组织管理','org_unit','parent_id','created_by',1,1,NULL,1),(2,1,'student','学生信息','student','学生管理','student','org_unit_id','created_by',10,1,NULL,1),(3,1,'school_class','班级管理','student','学生管理','school_class','org_unit_id','created_by',11,1,NULL,1),(4,1,'attendance','考勤记录','student','学生管理','attendance','class_id','recorded_by',12,1,NULL,1),(5,1,'teaching_task','教学任务','teaching','教学管理','teaching_task','org_unit_id','created_by',20,1,NULL,1),(6,1,'exam_batch','考试管理','teaching','教学管理','exam_batch','','created_by',21,1,NULL,1),(7,1,'student_grade','学生成绩','teaching','教学管理','student_grade','class_id','',22,1,NULL,1),(8,1,'inspection_template','检查模板','inspection','检查平台','inspection_template','org_unit_id','created_by',30,1,NULL,1),(9,1,'inspection_record','检查记录','inspection','检查平台','inspection_record','org_unit_id','created_by',31,1,NULL,1),(10,1,'place','场所管理','place','场所管理','place','org_unit_id','created_by',40,1,NULL,1);
/*!40000 ALTER TABLE `data_modules` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `role_data_scopes` (
  ...
  `custom_org_unit_ids` json DEFAULT NULL COMMENT 'CUSTOM 时用',
  `priority` int DEFAULT '0',
  `tenant_id` bigint NOT NULL DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `role_data_scopes` VALUES (1,2022900002094850049,'schedule_entry','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(2,2022900002094850049,'class_course_assignment','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(3,2022900002094850049,'semester_offering','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(4,2022900002094850049,'scheduling_constraint','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(5,2022900002094850049,'schedule_conflict_record','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(6,2022900002094850053,'schedule_entry','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(7,2022900002094850053,'class_course_assignment','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(8,2022900002094850053,'semester_offering','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(9,2022900002094850053,'scheduling_constraint','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(10,2022900002094850053,'schedule_conflict_record','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(11,2022900002094850049,'teacher_preference','SELF',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(12,2022900002094850053,'teacher_preference','ALL',NULL,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(13,2022900002094850049,'teaching_progress','SELF',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(14,2022900002094850053,'teaching_progress','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(15,2022900002094850049,'course_evaluation','DEPARTMENT',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(16,2022900002094850049,'evaluation_response','SELF',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(17,2022900002094850053,'course_evaluation','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(18,2022900002094850053,'evaluation_response','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(37,2022900002094850052,'student','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(38,2022900002094850052,'school_class','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(39,2022900002094850052,'dashboard','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(40,2022900002094850052,'teaching_task','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(41,2022900002094850053,'teaching_task','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(42,2022900002094850053,'student','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(43,2022900002094850053,'school_class','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(44,2022900002094850060,'student','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(45,2022900002094850060,'school_class','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(46,2022900002094850060,'dashboard','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(47,2022900002094850054,'student','BY_GRADE',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(48,2022900002094850054,'school_class','BY_GRADE',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(49,2022900002094850055,'student','BY_CLASS',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(50,2022900002094850055,'attendance','BY_CLASS',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(51,2022900002094850055,'student_grade','BY_CLASS',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(52,2022900002094850056,'student','BY_CLASS',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(53,2022900002094850056,'teaching_task','ALL',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(54,2022900002094850057,'student','DEPARTMENT_AND_BELOW',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(55,2022900002094850061,'student','SELF',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(56,2022900002094850061,'attendance','SELF',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(57,2022900002094850061,'student_grade','SELF',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(58,2022900002094850062,'student','SELF',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(59,2022900002094850062,'attendance','SELF',NULL,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0);
