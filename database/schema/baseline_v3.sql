...
CREATE TABLE `role_data_scopes` (
  ...
  `scope_type` varchar(30) NOT NULL COMMENT '[弃用,T9删] 旧扁平范围; 真相已迁三轴列',
  `custom_org_unit_ids` json DEFAULT NULL COMMENT '[弃用,T9删] 旧 CUSTOM 组织集; 已迁 custom_org_ids',
