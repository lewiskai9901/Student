...
CREATE TABLE `data_resources` (
  ...
  `org_unit_field` varchar(50) DEFAULT NULL COMMENT '业务表里指向组织的字段',
  `creator_field` varchar(50) DEFAULT NULL,
...
INSERT INTO `data_resources` (`resource_code`,`resource_name`,`domain_code`,`industry`,`domain_name`,`org_unit_field`,`creator_field`,`registered_by`,`sort_order`,`enabled`,`tenant_id`,`created_at`,`plugin_enabled`,`allowed_scopes`,`access_resource_type`) VALUES ('attendance','考勤','education','EDU','教育','org_unit_id','recorded_by','EducationPlugin',22,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"BY_GRADE\", \"BY_CLASS\", \"BY_MAJOR\", \"SELF\", \"CUSTOM\"]',NULL),('dashboard','仪表盘','CORE','CORE','核心',NULL,NULL,'CORE',40,1,1,'2026-06-01 22:57:32',1,'[\"SELF\"]',NULL),('dormitory_building','宿舍楼','education','EDU','教育',NULL,NULL,'EducationPlugin',50,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('dormitory_checkin','住宿登记','education','EDU','教育',NULL,NULL,'EducationPlugin',51,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('dormitory_room','宿舍房间','education','EDU','教育',NULL,NULL,'EducationPlugin',52,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('exam','考试','education','EDU','教育',NULL,NULL,'EducationPlugin',21,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"BY_CLASS\", \"SELF\", \"CUSTOM\"]',NULL),('exam_batch','考试批次','education','EDU','教育',NULL,NULL,'EducationPlugin',25,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"BY_CLASS\", \"SELF\", \"CUSTOM\"]',NULL),('grade_batch','成绩批次','education','EDU','教育','org_unit_id','created_by','EducationPlugin',20,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"BY_CLASS\", \"SELF\", \"CUSTOM\"]',NULL),('inspection','检查记录','inspection','CORE','检查平台','org_unit_id','created_by','InspectionPlugin',30,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_alert','预警记录','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',39,1,1,'2026-06-01 22:57:39',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_appeal','检查申诉','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',31,1,1,'2026-06-01 22:57:32',1,'[\"SELF\"]',NULL),('inspection_audit','检查审计日志','inspection','CORE','检查平台',NULL,NULL,'CORE',0,1,1,'2026-06-01 22:57:37',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_corrective','整改任务','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',32,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_observation','评分观察','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',41,1,1,'2026-06-01 22:57:39',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_personal','个人评级','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',33,1,1,'2026-06-01 22:57:32',1,'[\"SELF\"]',NULL),('inspection_project','检查项目','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',34,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_record','检查记录','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',35,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_summary','检查汇总','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',36,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"CUSTOM\"]',NULL),('inspection_task','检查任务','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',37,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('inspection_template','检查模板','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',38,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"SELF\"]',NULL),('inspection_violation','违规记录','inspection','CORE','检查平台',NULL,NULL,'InspectionPlugin',40,1,1,'2026-06-01 22:57:39',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('notification','消息','CORE','CORE','核心',NULL,NULL,'CORE',5,1,1,'2026-06-01 22:57:30',1,'[\"SELF\"]',NULL),('org_unit','组织','CORE','CORE','核心','parent_id','created_by','CORE',2,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('place','场所','CORE','CORE','核心',NULL,'created_by','CORE',3,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('role','角色','CORE','CORE','核心',NULL,'created_by','CORE',4,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('school_class','班级','education','EDU','教育',NULL,NULL,'EducationPlugin',11,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"BY_CLASS\", \"BY_MAJOR\", \"SELF\", \"CUSTOM\"]',NULL),('student','学生','education','EDU','教育',NULL,NULL,'EducationPlugin',10,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"BY_GRADE\", \"BY_CLASS\", \"BY_MAJOR\", \"SELF\", \"CUSTOM\"]',NULL),('student_grade','学生成绩','education','EDU','教育',NULL,NULL,'EducationPlugin',24,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"BY_CLASS\", \"SELF\", \"CUSTOM\"]',NULL),('system_role','系统角色','CORE','CORE','核心',NULL,NULL,'CORE',45,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('system_user','系统用户','CORE','CORE','核心',NULL,NULL,'CORE',46,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL),('teaching_task','教学任务','education','EDU','教育',NULL,NULL,'EducationPlugin',23,1,1,'2026-06-01 22:57:32',1,'[\"ALL\", \"BY_CLASS\", \"BY_MAJOR\", \"SELF\", \"CUSTOM\"]',NULL),('user','用户','CORE','CORE','核心',NULL,'created_by','CORE',1,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]',NULL);
-- R2.2 前置②: entity_events 独立资源码 (表无 org_unit_id, 锚点照搬 created_by 现状, 字节等价)
INSERT INTO `data_resources` (`resource_code`,`resource_name`,`domain_code`,`industry`,`domain_name`,`creator_field`,`registered_by`,`sort_order`,`enabled`,`tenant_id`,`created_at`,`plugin_enabled`,`allowed_scopes`) VALUES ('entity_event','实体事件','inspection','CORE','检查平台','created_by','CORE',47,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"SELF\"]');
-- R2.2 前置①: 激活 8 个此前无 data_resources 行的教务/排课模块 (注解本意是过滤, 缺行=不过滤越权面)
INSERT INTO `data_resources` (`resource_code`,`resource_name`,`domain_code`,`industry`,`domain_name`,`org_unit_field`,`creator_field`,`registered_by`,`sort_order`,`enabled`,`tenant_id`,`created_at`,`plugin_enabled`,`allowed_scopes`) VALUES
 ('teaching_progress','教学进度','education','EDU','教育','org_unit_id','recorded_by','EducationPlugin',60,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('class_course_assignment','排课分配','education','EDU','教育','org_unit_id','created_by','EducationPlugin',61,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('course_evaluation','课程评教','education','EDU','教育','org_unit_id','created_by','EducationPlugin',62,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('evaluation_response','评教作答','education','EDU','教育','org_unit_id','student_id','EducationPlugin',63,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('scheduling_constraint','排课约束','education','EDU','教育','org_unit_id','created_by','EducationPlugin',64,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('schedule_entry','课表条目','education','EDU','教育','org_unit_id','created_by','EducationPlugin',65,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('schedule_conflict_record','排课冲突','education','EDU','教育','org_unit_id','created_by','EducationPlugin',66,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"DEPARTMENT_AND_BELOW\", \"DEPARTMENT\", \"SELF\", \"CUSTOM\"]'),
 ('teacher_preference','教师偏好','education','EDU','教育',NULL,'teacher_id','EducationPlugin',67,1,1,'2026-06-01 22:57:30',1,'[\"ALL\", \"SELF\"]');
...
CREATE TABLE `role_data_scopes` (
  ...
  `org_anchor` varchar(20) DEFAULT NULL COMMENT 'axis① 组织锚点: ALL/SELF/PRIMARY_ORG/RELATION/CUSTOM_ORG/PLUGIN_DIM',
  `anchor_param` varchar(50) DEFAULT NULL COMMENT 'RELATION→关系码(admin); PLUGIN_DIM→维度码(BY_CLASS…)',
  `include_subtree` tinyint(1) NOT NULL DEFAULT '0' COMMENT '组织锚点是否含子树',
...
INSERT INTO `role_data_scopes` (`id`,`role_id`,`resource_code`,`apply_to`,`org_anchor`,`anchor_param`,`include_subtree`,`priority`,`tenant_id`,`created_at`,`updated_at`,`deleted`) VALUES (1,2022900002094850049,'schedule_entry','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(2,2022900002094850049,'class_course_assignment','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(3,2022900002094850049,'semester_offering','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(4,2022900002094850049,'scheduling_constraint','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(5,2022900002094850049,'schedule_conflict_record','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(6,2022900002094850053,'schedule_entry','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(7,2022900002094850053,'class_course_assignment','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(8,2022900002094850053,'semester_offering','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(9,2022900002094850053,'scheduling_constraint','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(10,2022900002094850053,'schedule_conflict_record','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(11,2022900002094850049,'teacher_preference','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(12,2022900002094850053,'teacher_preference','BOTH','ALL',NULL,0,0,1,'2026-06-01 22:57:41','2026-06-01 22:57:41',0),(13,2022900002094850049,'teaching_progress','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(14,2022900002094850053,'teaching_progress','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(15,2022900002094850049,'course_evaluation','BOTH','PRIMARY_ORG',NULL,0,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(16,2022900002094850049,'evaluation_response','BOTH','SELF',NULL,0,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(17,2022900002094850053,'course_evaluation','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(18,2022900002094850053,'evaluation_response','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 22:57:42','2026-06-01 22:57:42',0),(37,2022900002094850052,'student','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(38,2022900002094850052,'school_class','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(39,2022900002094850052,'dashboard','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(40,2022900002094850052,'teaching_task','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(41,2022900002094850053,'teaching_task','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(42,2022900002094850053,'student','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(43,2022900002094850053,'school_class','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(44,2022900002094850060,'student','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(45,2022900002094850060,'school_class','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(46,2022900002094850060,'dashboard','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(47,2022900002094850054,'student','BOTH','PLUGIN_DIM','BY_GRADE',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(48,2022900002094850054,'school_class','BOTH','PLUGIN_DIM','BY_GRADE',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(49,2022900002094850055,'student','BOTH','PLUGIN_DIM','BY_CLASS',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(50,2022900002094850055,'attendance','BOTH','PLUGIN_DIM','BY_CLASS',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(51,2022900002094850055,'student_grade','BOTH','PLUGIN_DIM','BY_CLASS',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(52,2022900002094850056,'student','BOTH','PLUGIN_DIM','BY_CLASS',0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(53,2022900002094850056,'teaching_task','BOTH','ALL',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(54,2022900002094850057,'student','BOTH','PRIMARY_ORG',NULL,1,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(55,2022900002094850061,'student','BOTH','SELF',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(56,2022900002094850061,'attendance','BOTH','SELF',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(57,2022900002094850061,'student_grade','BOTH','SELF',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(58,2022900002094850062,'student','BOTH','SELF',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0),(59,2022900002094850062,'attendance','BOTH','SELF',NULL,0,0,1,'2026-06-01 23:36:06','2026-06-01 23:36:06',0);
/*!40000 ALTER TABLE `role_data_scopes` ENABLE KEYS */;
UNLOCK TABLES;

-- T9: seed 行已直接写三轴列 (org_anchor/anchor_param/include_subtree), scope_type 列已删, 无需翻译。
