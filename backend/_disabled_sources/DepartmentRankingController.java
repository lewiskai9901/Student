 ...
 *
 * @deprecated 使用 {@link OrgRankingController} 代替，API路径为 /inspection/org-ranking
 */
@Deprecated
@RestController
@RequestMapping("/inspection/department-ranking")
@Tag(name = "Department Ranking (Deprecated)", description = "Department ranking query API - 请使用 /inspection/org-ranking")
