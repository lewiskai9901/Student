...
class UnifiedPluginPackageTest {
    ...
    @Test
    @DisplayName("PluginPackage 默认 metadata() 非 null; CoreManifest.contribute() 含 323 个 contribution (R3c P2: +inspection_record inspected PROVIDER)")
    void pluginPackageDefaultMethods() {
        ...
        assertEquals(323, count, "CoreManifest 应贡献 323 个 contribution (15 关系 + 3 workflow + 26 TENANT_ADMIN + 20 data-resource + 25 resource-relation + 3 role + 8 menu + 223 permission)");
