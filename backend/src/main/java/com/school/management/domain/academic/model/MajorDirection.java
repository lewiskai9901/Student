...
public class MajorDirection implements Entity<Long> {
    ...
    public static MajorDirection reconstitute(Long id, String directionCode, String directionName,
                                               ...
                                               String enrollmentTarget, String educationForm,
                                               List<String> certificateNames, String trainingStandard,
                                               String cooperationEnterprise, Integer maxEnrollment,
                                               Integer sortOrder) {
        ...
        direction.enrollmentTarget = enrollmentTarget;
        direction.educationForm = educationForm;
        direction.certificateNames = certificateNames;
        direction.trainingStandard = trainingStandard;
        direction.cooperationEnterprise = cooperationEnterprise;
        direction.maxEnrollment = maxEnrollment;
        direction.sortOrder = sortOrder != null ? sortOrder : 0;
        return direction;
    }
     ...
     * 更新技工院校增强字段
     */
    public void updateVocationalInfo(String enrollmentTarget, String educationForm,
                                      List<String> certificateNames, String trainingStandard,
                                      String cooperationEnterprise, Integer maxEnrollment,
                                      Integer sortOrder) {
    ...
    public String getTrainingStandard() {
        return trainingStandard;
    }

    public String getCooperationEnterprise() {
