...
/**
 * Domain event raised when an inspection session is submitted.
 */
public class SessionSubmittedEvent extends BaseDomainEvent {
    ...
    public SessionSubmittedEvent(Long sessionId, String sessionCode, Long templateId,
