 ...
 * 年级开设专业方向仓储接口
 */
public interface CohortOpenedDirectionRepository extends Repository<CohortOpenedDirection, Long> {

    /**
     * 根据年级ID查找开设的专业方向
     */
    List<CohortOpenedDirection> findByGradeId(Long gradeId);

    /**
     * 根据专业方向ID查找开设的年级
     */
    List<CohortOpenedDirection> findByMajorDirectionId(Long majorDirectionId);

    /**
     * 根据年级ID和专业方向ID查找
     */
    Optional<CohortOpenedDirection> findByGradeIdAndMajorDirectionId(Long gradeId, Long majorDirectionId);
