...
public class CaseVerifiedEvent extends BaseDomainEvent implements InspV7DomainEvent {

    private final Long caseId;
    private final String caseCode;
    private final Long verifierId;

    public CaseVerifiedEvent(Long caseId, String caseCode, Long verifierId) {
