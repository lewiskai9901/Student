...
import com.school.management.domain.inspection.event.TemplatePublishedEvent;
...
public class TemplateSection extends AggregateRoot<Long> {
    ...
    private String targetTypeFilter;   // 例如 "entityTypeCode=CLASS" 或 "category=DORMITORY" (nullable, 通用核心通过 entity_type_configs 表达行业语义)
