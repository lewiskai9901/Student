...
public class CalculationRule implements Entity<Long> {
    ...
    private CalculationRule(Builder builder) {
        this.id = builder.id;
    ...
    public static CalculationRule reconstruct(Builder builder) {
        return new CalculationRule(builder);
    }
    ...
    public static class Builder {
        ...
        public CalculationRule build() {
            return new CalculationRule(this);
        }
    }
}
