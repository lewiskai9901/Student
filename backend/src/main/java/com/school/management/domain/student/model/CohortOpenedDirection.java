 ...
 * - 同一年级不能重复开设同一专业方向
 */
public class CohortOpenedDirection implements Entity<Long> {
    ...
    // For JPA/MyBatis
    protected CohortOpenedDirection() {
    }

    private CohortOpenedDirection(Long gradeId, Long majorDirectionId,
     ...
     * 工厂方法
     */
    public static CohortOpenedDirection create(Long gradeId, Long majorDirectionId,
                                               Integer plannedClasses, Integer plannedStudents,
                                               String remarks, Long createdBy) {
        return new CohortOpenedDirection(gradeId, majorDirectionId,
     ...
     * 用于从数据库重建
     */
    public static CohortOpenedDirection reconstitute(Long id, Long gradeId, Long majorDirectionId,
                                                     Integer plannedClasses, Integer plannedStudents,
                                                     String remarks, Boolean enabled,
                                                     LocalDateTime createdAt, LocalDateTime updatedAt,
                                                     Long createdBy, Long updatedBy) {
        CohortOpenedDirection entity = new CohortOpenedDirection();
        entity.id = id;
