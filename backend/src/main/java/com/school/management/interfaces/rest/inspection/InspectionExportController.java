...
public class InspectionExportController {
    ...
    private final InspectionExportApplicationService exportService;
    ...
    public ResponseEntity<byte[]> exportCorrective(
        ...
        List<Map<String, Object>> rows = exportService.queryCorrective(projectId, status);
    ...
    public ResponseEntity<byte[]> exportAppeals() {
        List<Map<String, Object>> rows = exportService.queryAppeals();
    ...
    public ResponseEntity<byte[]> exportAudit(
        ...
        List<Map<String, Object>> rows = exportService.queryAudit(aggregateType);
