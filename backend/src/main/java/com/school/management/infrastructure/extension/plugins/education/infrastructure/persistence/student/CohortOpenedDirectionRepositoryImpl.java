 ...
 */
@Repository
public class CohortOpenedDirectionRepositoryImpl implements CohortOpenedDirectionRepository {

    private final GradeMajorDirectionMapper mapper;

    public CohortOpenedDirectionRepositoryImpl(GradeMajorDirectionMapper mapper) {
        this.mapper = mapper;
    }

    @Override
    public Optional<CohortOpenedDirection> findById(Long id) {
        GradeMajorDirectionPO po = mapper.selectById(id);
        return Optional.ofNullable(po).map(this::toDomain);
    }

    @Override
    public CohortOpenedDirection save(CohortOpenedDirection entity) {
    ...
    @Override
    public void delete(CohortOpenedDirection entity) {
    ...
    @Override
    public List<CohortOpenedDirection> findByGradeId(Long gradeId) {
    ...
    @Override
    public List<CohortOpenedDirection> findByMajorDirectionId(Long majorDirectionId) {
    ...
    @Override
    public Optional<CohortOpenedDirection> findByGradeIdAndMajorDirectionId(Long gradeId, Long majorDirectionId) {
    ...
    private GradeMajorDirectionPO toPO(CohortOpenedDirection domain) {
    ...
    private CohortOpenedDirection toDomain(GradeMajorDirectionPO po) {
        return CohortOpenedDirection.reconstitute(
                po.getId(),
                po.getGradeId(),
