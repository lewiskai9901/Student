...
public class CorePermissionProvider implements PermissionProvider {
    ...
    public List<PermissionDef> getPermissions() {
        return List.of(
            ...
            of("insp:platform:manage", "V7检查平台管理", ""),
            of("insp:platform:view", "V7检查平台查看", ""),
            of("insp:project:create", "V7项目创建", ""),
            of("insp:project:delete", "删除项目", ""),
            of("insp:project:edit", "V7项目编辑", ""),
            of("insp:project:manage", "V7项目管理", ""),
            of("insp:project:publish", "发布项目", ""),
            of("insp:project:view", "V7项目查看", ""),
            of("insp:rating:manage", "管理评分", ""),
            of("insp:rating:view", "查看评分", ""),
            of("insp:rating-link:manage", "V7评级链接管理", ""),
            of("insp:rating-link:view", "V7评级链接查看", ""),
            of("insp:response-set:create", "创建选项集", ""),
            of("insp:response-set:delete", "删除选项集", ""),
            of("insp:response-set:edit", "编辑选项集", ""),
            of("insp:response-set:manage", "V7选项集管理", ""),
            of("insp:response-set:view", "V7选项集查看", ""),
            ...
            of("insp:scoring-profile:edit", "V7评分配置编辑", ""),
            of("insp:scoring-profile:view", "V7评分配置查看", ""),
            of("insp:submission:admin", "管理提交", ""),
            of("insp:submission:create", "创建提交", ""),
            of("insp:submission:execute", "执行提交", ""),
            of("insp:submission:view", "查看提交", ""),
            of("insp:sync:access", "V7离线同步", ""),
            of("insp:task:create", "创建任务", ""),
            of("insp:task:edit", "编辑任务", ""),
            of("insp:task:execute", "V7任务执行", ""),
            of("insp:task:publish", "发布任务", ""),
            of("insp:task:review", "V7任务审核", ""),
            of("insp:task:view", "V7任务查看", ""),
            of("insp:template:create", "V7模板创建", ""),
            of("insp:template:delete", "V7模板删除", ""),
            of("insp:template:edit", "V7模板编辑", ""),
            of("insp:template:publish", "V7模板发布", ""),
            of("insp:template:view", "V7模板查看", ""),
