...
public class CorePermissionProvider implements PermissionProvider {
    ...
    public List<PermissionDef> getPermissions() {
        return List.of(
            ...
            of("insp:appeal:view", "申诉查看", ""),
            of("insp:audit:view", "审计查看", ""),
            of("inspection_appeal:create", "创建申诉", ""),
            of("inspection_appeal:review", "审核申诉", ""),
            of("inspection_appeal:view", "查看申诉", ""),
            of("system:message:manage", "系统消息管理", ""),
            ...
            of("insp:template:update", "模板项规则更新", ""),
