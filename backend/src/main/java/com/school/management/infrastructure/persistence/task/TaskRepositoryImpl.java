...
public class TaskRepositoryImpl implements TaskRepository {
    ...
    @Override
    public List<Task> findPendingApprovalByUserId(Long approverId) {
        LambdaQueryWrapper<TaskPO> wrapper = new LambdaQueryWrapper<>();
    ...
    public List<Task> findByAssigneeUserId(Long userId) {
        LambdaQueryWrapper<TaskPO> wrapper = new LambdaQueryWrapper<>();
        wrapper.apply("JSON_CONTAINS(target_ids, CAST({0} AS JSON))", userId);
        wrapper.orderByDesc(TaskPO::getCreatedAt);
    ...
    @Override
    public long countByAssigneeUserIdAndStatus(Long userId, TaskStatus status) {
        LambdaQueryWrapper<TaskPO> wrapper = new LambdaQueryWrapper<>();
    ...
    @Override
    public Long nextId() {
        // Snowflake ID is generated by MyBatis Plus automatically
        return null;
    }
