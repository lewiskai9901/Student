...
public class ResourceRelationUpserter {
    ...
    public void upsert(ResourceRelationDef def, String industry) {
        jdbc.update(
            ...
            " column_name, type_column, ar_relation, auto_fill, grants_by_default, industry, enabled, tenant_id) " +
            "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,1,1) " +
            ...
            " ar_relation=VALUES(ar_relation), auto_fill=VALUES(auto_fill), " +
            ...
            def.columnName(), def.typeColumn(), def.arRelation(),
