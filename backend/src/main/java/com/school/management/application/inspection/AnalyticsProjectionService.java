...
public class AnalyticsProjectionService {
    ...
    public void rebuildCorrectiveSummary(Long projectId) {
        ...
        List<com.school.management.domain.inspection.model.corrective.CorrectiveCase> cases =
        ...
        summary.setOverdueCases((int) cases.stream().filter(com.school.management.domain.inspection.model.corrective.CorrectiveCase::isOverdue).count());
