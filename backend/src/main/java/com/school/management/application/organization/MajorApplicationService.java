...
import com.school.management.application.organization.command.CreateMajorCommand;
import com.school.management.application.organization.command.CreateMajorDirectionCommand;
import com.school.management.application.organization.command.UpdateMajorCommand;
import com.school.management.application.organization.command.UpdateMajorDirectionCommand;
import com.school.management.application.organization.query.MajorDTO;
import com.school.management.application.organization.query.MajorDirectionDTO;
...
public class MajorApplicationService {
    ...
    public MajorDirectionDTO updateDirection(Long id, UpdateMajorDirectionCommand command) {
        ...
        if (direction != null && command.getRemarks() != null) {
            direction.setRemarks(command.getRemarks());
        }
