...
describe('V2 Access API', () => {
  ...
  describe('Permission API', () => {
    describe('getPermissions', () => {
      it('should call GET /v2/permissions', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/permissions', { params: undefined })
      ...
      it('should call with query params', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/permissions', { params })
      })
    })

    describe('getPermissionTree', () => {
      it('should call GET /v2/permissions/tree', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/permissions/tree')
        expect(result).toEqual(mockTree)
      })
    })

    describe('getPermission', () => {
      it('should call GET /v2/permissions/:id', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/permissions/1')
        expect(result).toEqual(mockPermission)
      })
    })

    describe('createPermission', () => {
      it('should call POST /v2/permissions', async () => {
        ...
        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/permissions', data)
        expect(result).toEqual(mockPermission)
      })
    })

    describe('updatePermission', () => {
      it('should call PUT /v2/permissions/:id', async () => {
        ...
        expect(mockedHttp.put).toHaveBeenCalledWith('/v2/permissions/1', data)
        expect(result).toEqual(mockPermission)
      })
    })

    describe('deletePermission', () => {
      it('should call DELETE /v2/permissions/:id', async () => {
        mockedHttp.delete.mockResolvedValue(undefined)

        await deletePermission(1)

        expect(mockedHttp.delete).toHaveBeenCalledWith('/v2/permissions/1')
      })
    })

    describe('enablePermission', () => {
      it('should call POST /v2/permissions/:id/enable', async () => {
        mockedHttp.post.mockResolvedValue(undefined)

        await enablePermission(1)

        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/permissions/1/enable')
      })
    })

    describe('disablePermission', () => {
      it('should call POST /v2/permissions/:id/disable', async () => {
        mockedHttp.post.mockResolvedValue(undefined)

        await disablePermission(1)

        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/permissions/1/disable')
      })
    })
  })
  ...
  describe('Role API', () => {
    describe('getRoles', () => {
      it('should call GET /v2/roles', async () => {
        const mockRoles = [{ id: 1, roleCode: 'admin', roleName: '管理员' }]
        mockedHttp.get.mockResolvedValue(mockRoles)

        const result = await getRoles()

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles', { params: { roleType: undefined } })
      ...
      it('should call with roleType param', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles', { params: { roleType: 'TEACHER' } })
      })
    })

    describe('getAllRoles', () => {
      it('should call GET /v2/roles without params', async () => {
        const mockRoles = [{ id: 1, roleCode: 'admin' }, { id: 2, roleCode: 'teacher' }]
        mockedHttp.get.mockResolvedValue(mockRoles)

        const result = await getAllRoles()

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles')
        expect(result).toEqual(mockRoles)
      })
    })

    describe('getRole', () => {
      it('should call GET /v2/roles/:id', async () => {
        const mockRole = { id: 1, roleCode: 'admin', roleName: '管理员' }
        mockedHttp.get.mockResolvedValue(mockRole)

        const result = await getRole(1)

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles/1')
        expect(result).toEqual(mockRole)
      })
    })

    describe('createRole', () => {
      it('should call POST /v2/roles', async () => {
        ...
        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/roles', data)
        expect(result).toEqual(mockRole)
      })
    })

    describe('updateRole', () => {
      it('should call PUT /v2/roles/:id', async () => {
        ...
        expect(mockedHttp.put).toHaveBeenCalledWith('/v2/roles/1', data)
        expect(result).toEqual(mockRole)
      })
    })

    describe('deleteRole', () => {
      it('should call DELETE /v2/roles/:id', async () => {
        mockedHttp.delete.mockResolvedValue(undefined)

        await deleteRole(1)

        expect(mockedHttp.delete).toHaveBeenCalledWith('/v2/roles/1')
      })
    })

    describe('enableRole', () => {
      it('should call POST /v2/roles/:id/enable', async () => {
        mockedHttp.post.mockResolvedValue(undefined)

        await enableRole(1)

        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/roles/1/enable')
      })
    })

    describe('disableRole', () => {
      it('should call POST /v2/roles/:id/disable', async () => {
        mockedHttp.post.mockResolvedValue(undefined)

        await disableRole(1)

        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/roles/1/disable')
      })
    })

    describe('setRolePermissions', () => {
      it('should call PUT /v2/roles/:id/permissions', async () => {
        const mockRole = { id: 1, permissionIds: [1, 2, 3] }
        mockedHttp.put.mockResolvedValue(mockRole)

        const result = await setRolePermissions(1, [1, 2, 3])

        expect(mockedHttp.put).toHaveBeenCalledWith('/v2/roles/1/permissions', { permissionIds: [1, 2, 3] })
        expect(result).toEqual(mockRole)
      })
    })

    describe('getRolePermissions', () => {
      it('should call GET /v2/roles/:id/permissions', async () => {
        const mockPermissions = [{ id: 1, permissionCode: 'user:read' }]
        mockedHttp.get.mockResolvedValue(mockPermissions)

        const result = await getRolePermissions(1)

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles/1/permissions')
        expect(result).toEqual(mockPermissions)
      })
    })

    describe('getRoleUsers', () => {
      it('should call GET /v2/roles/:id/users', async () => {
        ...
        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/roles/1/users', { params: { pageNum: 1, pageSize: 10 } })
  ...
  describe('User Role API', () => {
    describe('getUserRoles', () => {
      it('should call GET /v2/users/:id/roles', async () => {
        const mockRoles = [{ roleId: 1, roleName: '管理员' }]
        mockedHttp.get.mockResolvedValue(mockRoles)

        const result = await getUserRoles(1)

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/users/1/roles')
        expect(result).toEqual(mockRoles)
      })
    })

    describe('assignRoleToUser', () => {
      it('should call POST /v2/users/:id/roles', async () => {
        mockedHttp.post.mockResolvedValue(undefined)

        const data = { roleId: 1, scopeType: 'DEPARTMENT', scopeId: 100 }
        await assignRoleToUser(1, data)

        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/users/1/roles', data)
      })
    })

    describe('setUserRoles', () => {
      it('should call PUT /v2/users/:id/roles', async () => {
        mockedHttp.put.mockResolvedValue(undefined)

        const data = { roleIds: [1, 2] }
        await setUserRoles(1, data)

        expect(mockedHttp.put).toHaveBeenCalledWith('/v2/users/1/roles', data)
      })
    })

    describe('removeUserRole', () => {
      it('should call DELETE /v2/users/:userId/roles/:roleId', async () => {
        mockedHttp.delete.mockResolvedValue(undefined)

        await removeUserRole(1, 2)

        expect(mockedHttp.delete).toHaveBeenCalledWith('/v2/users/1/roles/2')
      })
    })

    describe('getCurrentUserPermissions', () => {
      it('should call GET /v2/users/current/permissions', async () => {
        const mockPermissions = [{ id: 1, permissionCode: 'user:read' }]
        mockedHttp.get.mockResolvedValue(mockPermissions)

        const result = await getCurrentUserPermissions()

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/users/current/permissions')
        expect(result).toEqual(mockPermissions)
      })
    })

    describe('getCurrentUserRoles', () => {
      it('should call GET /v2/users/current/roles', async () => {
        const mockRoles = [{ roleId: 1, roleName: '管理员' }]
        mockedHttp.get.mockResolvedValue(mockRoles)

        const result = await getCurrentUserRoles()

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/users/current/roles')
        expect(result).toEqual(mockRoles)
      })
    })

    describe('checkPermission', () => {
      it('should call GET /v2/users/current/check', async () => {
        mockedHttp.get.mockResolvedValue(true)

        const result = await checkPermission('user:read')

        expect(mockedHttp.get).toHaveBeenCalledWith('/v2/users/current/check', { params: { permissionCode: 'user:read' } })
        expect(result).toBe(true)
      })
    })

    describe('checkPermissions', () => {
      it('should call POST /v2/users/current/check-batch', async () => {
        ...
        expect(mockedHttp.post).toHaveBeenCalledWith('/v2/users/current/check-batch', { permissionCodes: ['user:read', 'user:write'] })
