...
import type { PageResponse, PageParams } from '@/types/v2'

// 后端API路径 - 对应后端DDD接口层Controller
const TEMPLATE_URL = '/v2/inspection-templates'
const RECORD_URL = '/v2/inspection-records'
const APPEAL_URL = '/v2/appeals'
