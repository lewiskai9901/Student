...
import type { SchedulePolicy, ScheduleExecution, CreatePolicyRequest } from '@/types/v2/schedule'

const POLICY_URL = '/v2/schedule/policies'
const EXECUTION_URL = '/v2/schedule/executions'
