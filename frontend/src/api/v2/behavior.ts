...
import type { BehaviorRecord, CreateBehaviorRecordRequest, BehaviorProfile, BehaviorAlert } from '@/types/v2/behavior'

const RECORD_URL = '/v2/behavior-records'
const ALERT_URL = '/v2/behavior-alerts'
