 ...
 * 获取盘点任务详情
 */
export function getInventory(id: LongId | string): Promise<AssetInventory> {
 ...
 * 完成盘点
 */
export function completeInventory(id: LongId | string): Promise<void> {
 ...
 * 取消盘点
 */
export function cancelInventory(id: LongId | string): Promise<void> {
