    ...
    <el-card class="filter-card">
      <el-form :inline="true" :model="queryParams">
        <el-form-item label="关键词">
          <el-input v-model="queryParams.keyword" placeholder="课程名称/编码" clearable @keyup.enter="search" />
        </el-form-item>
    ...
    <el-card class="table-card">
      <template #header>
        <div class="card-header">
          <span>课程列表</span>
          <el-button type="primary" @click="showDialog()">新建课程</el-button>
        </div>
      </template>
...
const loadCourses = async () => {
  loading.value = true
  try {
    const res = await courseApi.list(queryParams)
