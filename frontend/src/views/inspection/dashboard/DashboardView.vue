      ...
      <el-col :span="12">
        <el-card shadow="never">
          ...
          <div class="flex flex-wrap gap-3">
            <el-button @click="router.push('/inspection/projects')">检查项目</el-button>
            <el-button @click="router.push('/inspection/templates/create')">创建模板</el-button>
            <el-button @click="router.push('/inspection/tasks')">检查任务</el-button>
            <el-button @click="router.push('/inspection/analytics')">分析报表</el-button>
            <el-button @click="router.push('/inspection/corrective')">整改管理</el-button>
            <el-button @click="router.push('/inspection/scoring')">评分配置</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="12">
