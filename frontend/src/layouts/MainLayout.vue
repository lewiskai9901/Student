...
const iconComponents: Record<string, any> = {
  ...
  // 床位/宿舍图标
  Bed: () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
    h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M3 7v11m0-4h18m0 0V8a1 1 0 00-1-1H8a1 1 0 00-1 1v3m14 0v4m-18 0h18M5 7v1a2 2 0 002 2h0a2 2 0 002-2V7' })
  ]),
}
